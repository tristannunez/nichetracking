...
# plot SONP
png(filename = "./figures/sonp_Nov9.png",
...
# plot ONP
png(filename = "./figures/onp_Nov9.png",
    width = 15, height = 4, units = "in", pointsize = .5,
    bg = "transparent",  res = 300)
multiplot(plot.pers.desert, 
          plot.pers.scrub,
...
plot.omission.pers.desert <- ggplot(combos.desert, aes(as.numeric(dispersal)*4, omission.m, group=as.factor(persistence), colour=as.factor(persistence))) + 
  ...
  labs(x="Dispersal Ability, km", y="Omission", colour="Persistence \n Ability (yr)") 
#plot.pers
...
# plot omission
png(filename = "./figures/omission_Nov11.png",
    width = 15, height = 4, units = "in", pointsize = .5,
    bg = "transparent",  res = 300)
...
plot.commission.pers.desert <- ggplot(combos.desert, aes(as.numeric(dispersal)*4, commission.m, group=as.factor(persistence), colour=as.factor(persistence))) + 
  ...
  labs(x="Dispersal Ability, km", y="Commission", colour="Persistence \n Ability (yr)") 
#plot.pers
...
# plot commission
png(filename = "./figures/commission_Nov11.png",
    width = 15, height = 4, units = "in", pointsize = .5,
    bg = "transparent",  res = 300)
...
# plot commission
png(filename = "./figures/turnover_Nov13.png",
    width = 15, height = 4, units = "in", pointsize = .5,
    bg = "transparent",  res = 300)
turnover.plot
dev.off()
